                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <input id="firstName" name="firstName" size="30" type="text" maxlength="30" value="<%=user_req.getFirstName() %>" />
                                <span style="color:#FF0000;"><%=user_req.getErrorMsg("firstName") %></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <c:out value="Last Name:" /><br />
                                <input id="lastName" name="lastName" size="30" type="text" maxlength="30" value="<%=user_req.getLastName() %>" />
                                <span style="color:#FF0000;"><%=user_req.getErrorMsg("lastName") %></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <input id="confirm_pw" name="confirm_pw" size="30" type="password" maxlength="10" value="<%=user_req.getConfirm_pw() %>" />
                                <span style="color:#FF0000;"><%=user_req.getErrorMsg("confirm_pw") %></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
